...
The [safe releases lesson](../../docs/safe-releases-demo.md) runs at `/release-demo` and adds a browser-session analytics toggle, cancellation, and scoped diagnostic context.
